...
status "Deleting service account"
run_cmd "gcloud iam service-accounts delete dr-service-account@$PROJECT_ID.iam.gserviceaccount.com --quiet" "Service account not found or already deleted"
